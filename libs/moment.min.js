!(function (e, t) {
    ...
    function je() {
        ...
        for (var t, n, s = [], i = [], r = [], a = 0; a < 12; a++)
            (n = l([2e3, a])), (t = p(this.monthsShort(n, ""))), (n = p(this.months(n, ""))), s.push(t), i.push(n), r.push(n), r.push(t);
        s.sort(e),
            i.sort(e),
            r.sort(e),
            ...
            for (var t, n, s, i, r, a = "" + e._i, o = a.length, u = 0, l = ae(e._f, e._locale).match(te) || [], d = l.length, h = 0; h < d; h++)
                (n = l[h]),
                    (t = (a.match(De(n, e)) || [])[0]) &&
                        ...
                        (u += t.length)),
                    ie[n]
                        ? (t ? (m(e).empty = !1) : m(e).unusedTokens.push(n), (s = n), (r = e), null != (i = t) && c(Se, s) && Se[s](i, r._a, r, s))
    ...
    function Gt(e, t) {
        var n;
        return t._isUTC
            ? ((t = t.clone()), (n = (d(e) || V(e) ? e : R(e)).valueOf() - t.valueOf()), t._d.setTime(t._d.valueOf() + n), f.updateOffset(t, !1), t)
            : R(e).local();
    }
    function Et(e) {
    ...
    function C(e, t) {
        ...
        return (
            Ut(e)
                ...
                : (i = It.exec(e))
                ? ((n = "-" === i[1] ? -1 : 1),
                  (s = { y: 0, d: M(i[S]) * n, h: M(i[O]) * n, m: M(i[b]) * n, s: M(i[T]) * n, ms: M(Ht(1e3 * i[Te])) * n }))
                : (i = jt.exec(e))
                ? ((n = "-" === i[1] ? -1 : 1),
    ...
    function an() {
        for (var e, t, n, s = [], i = [], r = [], a = [], o = this.eras(), u = 0, l = o.length; u < l; ++u)
            (e = p(o[u].name)), (t = p(o[u].abbr)), (n = p(o[u].narrow)), i.push(e), s.push(t), r.push(n), a.push(e), a.push(t), a.push(n);
    ...
    (g.calendar = function (e, t, n) {
        ...
        (g.months = function (e, t) {
            return e
                ? (a(this._months) ? this._months : this._months[(this._months.isFormat || Ve).test(t) ? "format" : "standalone"])[e.month()]
                : a(this._months)
                ? this._months
        ...
        (g.monthsShort = function (e, t) {
            return e
                ? (a(this._monthsShort) ? this._monthsShort : this._monthsShort[Ve.test(t) ? "format" : "standalone"])[e.month()]
                : a(this._monthsShort)
                ? this._monthsShort
        ...
        (g.monthsRegex = function (e) {
            return this._monthsParseExact
                ...
                : (c(this, "_monthsRegex") || (this._monthsRegex = Ee), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
        }),
                    ...
                    ? ((s = ut),
                      null != W[e] && null != W[e].parentLocale
                          ...
                          : ((t = X((s = null != (n = ct(e)) ? n._config : s), t)),
                            ...
                            (W[e] = s)),
                      ft(e))
                    : null != W[e] && (null != W[e].parentLocale ? ((W[e] = W[e].parentLocale), e === ft() && ft(e)) : null != W[e] && delete W[e]),
                W[e]
            );
        }),
        (f.locales = function () {
